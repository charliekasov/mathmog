  ...
  if (reviewable.length === 0) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: "Nothing to replay" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Your misses used answer formats this review can't replay. Take a look at the explanations on the drill if you want a second pass." }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center text-sm text-muted-foreground", children: [
          ...
          " of ",
          reviewable.length,
          skippedCount > 0 && /* @__PURE__ */ jsxs("span", { className: "block text-xs mt-1", children: [
            skippedCount,
            " miss",
            skippedCount === 1 ? "" : "es",
...
var MemorizeContent = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsx(StudySection, { title: "Memorization Facts", children: /* @__PURE__ */ jsxs(PrintableAccordion, { type: "single", collapsible: true, className: "w-full", children: [
    /* @__PURE__ */ jsxs(ui.AccordionItem, { value: "item-1", children: [
      ...
      /* @__PURE__ */ jsx(ui.AccordionContent, { children: /* @__PURE__ */ jsx(ui.Table, { children: /* @__PURE__ */ jsx(ui.TableBody, { children: Object.entries(perfectSquares).slice(0, 20).reduce((acc, _, index, array) => {
        if (index % 4 === 0) {
          acc.push(array.slice(index, index + 4));
        }
        return acc;
      }, []).map((row, rowIndex) => /* @__PURE__ */ jsx(ui.TableRow, { className: "font-mono text-sm even:bg-muted/50", children: row.map(([base, square]) => /* @__PURE__ */ jsxs(ui.TableCell, { children: [
    ...
    /* @__PURE__ */ jsxs(ui.AccordionItem, { value: "item-2", children: [
      ...
      /* @__PURE__ */ jsx(ui.AccordionContent, { children: /* @__PURE__ */ jsx(ui.Table, { children: /* @__PURE__ */ jsx(ui.TableBody, { children: Object.entries(perfectCubes).slice(0, 10).reduce((acc, _, index, array) => {
        if (index % 4 === 0) {
          acc.push(array.slice(index, index + 4));
        }
        return acc;
      }, []).map((row, rowIndex) => /* @__PURE__ */ jsx(ui.TableRow, { className: "font-mono text-sm even:bg-muted/50", children: row.map(([base, cube]) => /* @__PURE__ */ jsxs(ui.TableCell, { children: [
        /* @__PURE__ */ jsxs("span", { className: "font-semibold", children: [
          base,
          "\xB3"
        ] }),
