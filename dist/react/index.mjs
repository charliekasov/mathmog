...
function ProblemProvider({ children }) {
  ...
  const handleNewProblem = useCallback((level, difficulty, topic) => {
  ...
  const handleLevelDifficultyChange = useCallback((level, difficulty, topic) => {
...
function DifficultySelector() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "mb-6 space-y-4", children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: cn(
