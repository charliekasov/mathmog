...
function ProblemProvider({ children }) {
  ...
  const [missDiagnosis, setMissDiagnosis] = React.useState(null);
  const [correctEnrichment, setCorrectEnrichment] = React.useState(null);
...
function PerMiss({ miss, onAdvance }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { className: "border-t-2 border-t-amber-300 shadow-sm", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.CardContent, { className: "pt-6 space-y-4", children: [
    ...
    miss.diagnosisMessage && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-center max-w-md mx-auto", children: miss.diagnosisMessage }),
            ...
            estimationTier && estimationTier !== "outside" ? (
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                "div",
                {
                  ...
                  children: feedback === "correct" ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                    "\u2705 Correct!",
                    correctEnrichment && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "block text-sm font-normal text-muted-foreground mt-1 max-w-md mx-auto", children: correctEnrichment })
                  ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-2xl", children: "\u{1F4AA}" }),
                    " Not quite!",
                    missDiagnosis && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "block text-base font-medium text-foreground mt-1 max-w-md mx-auto", children: missDiagnosis.message })
                  ] })
                }
              )
            ),
...
function LearnRoundSummaryBody({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "space-y-4 text-left max-w-md mx-auto", children: [
    missed.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs("div", { "data-learn-summary-missed": true, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-sm font-medium text-amber-700 dark:text-amber-500 mb-1", children: "Worth another look" }),
      /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "space-y-1", children: missed.map((item) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "text-base", children: [
        item.prompt,
        " = ",
        learnAnswerDisplay(item)
      ] }, item.id)) })
    ] }),
    newlySolid.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs("div", { "data-learn-summary-solid": true, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-sm font-medium text-green-700 dark:text-green-500 mb-1", children: "Now solid from memory" }),
      /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "space-y-1", children: newlySolid.map((item) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "text-base text-muted-foreground", children: [
        item.prompt,
        " = ",
        learnAnswerDisplay(item)
      ] }, item.id)) })
...
function LearnRoundSummaryScreen({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Card,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.CardContent, { className: "pt-6 pb-8 space-y-6 text-center", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(LearnRoundSummaryBody, { summary, items }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Button, { onClick: onContinue, className: "text-lg h-14 sm:h-11 px-8", children: [
          "Keep going ",
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "w-4 h-4 ml-2" })
        ] }) })
      ] })
...
function LearnCompletionScreen({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Card,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.CardContent, { className: "pt-6 pb-8 space-y-6 text-center", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-xs uppercase tracking-wide text-muted-foreground mb-2", children: moduleLabel }),
          /* @__PURE__ */ jsxRuntime.jsx("h2", { className: "text-xl font-semibold", children: totalFacts === 1 ? "You recalled this fact from memory." : `You recalled all ${totalFacts} facts from memory.` }),
          /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-sm text-muted-foreground mt-1", children: [
            "Facts solid: ",
            totalFacts,
            " of ",
        ...
        finalSummary !== null && /* @__PURE__ */ jsxRuntime.jsx(LearnRoundSummaryBody, { summary: finalSummary, items }),
        completionSlot !== void 0 && completionSlot !== null && /* @__PURE__ */ jsxRuntime.jsx("div", { "data-learn-completion-slot": true, children: completionSlot })
      ] })
    }
  );
}
...
function useAnyKeyContinue(active, onContinue) {
  const callbackRef = React.useRef(onContinue);
...
function LearnRecallCard({ item, topic, onAnswer }) {
  const ui = useMathmogUI();
  const [typed, setTyped] = React__namespace.useState("");
  const [phase, setPhase] = React__namespace.useState("answering");
  const [diagnosis, setDiagnosis] = React__namespace.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Card,
    {
      ...
      className: "border-t-2 border-t-amber-300 shadow-md",
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.CardContent, { className: "pt-6 pb-8 space-y-6", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-2xl md:text-3xl font-bold text-center", children: [
          item.prompt,
          " = ?"
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "max-w-md mx-auto space-y-3", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ui.Input,
            {
              ref: inputRef,
          ...
          answering && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsxs(
              ui.Button,
              {
                onClick: check,
        ...
        phase === "correct" && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-center text-lg font-semibold text-green-600", children: "Correct!" }),
        phase === "miss" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center space-y-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-lg font-semibold text-amber-600 dark:text-amber-500", children: "Not quite." }),
          diagnosis !== null && /* @__PURE__ */ jsxRuntime.jsx(
            "p",
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-base font-medium", children: [
            item.prompt,
            " = ",
            learnAnswerRevealDisplay(item)
          ] })
        ] }),
        phase === "dont-know" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center space-y-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-lg font-semibold text-amber-600 dark:text-amber-500", children: "No problem. Here it is:" }),
          /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-base font-medium", children: [
            item.prompt,
            " = ",
            learnAnswerRevealDisplay(item)
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-muted-foreground", children: "You'll get another shot at it in a moment." })
        ] }),
        !answering && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Button, { onClick: finish, className: "text-lg h-14 sm:h-11 px-8", children: [
          "Continue ",
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "w-4 h-4 ml-2" })
        ] }) })
      ] })
...
function LearnRecognizeCard({
  ...
  const ui = useMathmogUI();
  const [options] = React__namespace.useState(
    () => assembleRecognizeOptions(item, distractorSet, rng).options
  );
  const [phase, setPhase] = React__namespace.useState("answering");
  const [pickedIndex, setPickedIndex] = React__namespace.useState(null);
  const [highlightIndex, setHighlightIndex] = React__namespace.useState(null);
  const [diagnosis, setDiagnosis] = React__namespace.useState(null);
  const answering = phase === "answering";
  const correctIndex = options.indexOf(item.answer);
  const pick = React__namespace.useCallback(
    (index) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Card,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.CardContent, { className: "pt-6 pb-8 space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md mx-auto", children: options.map((option, index) => /* @__PURE__ */ jsxRuntime.jsxs(
          ui.Button,
          {
            variant: "outline",
            onClick: () => pick(index),
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { className: "hidden sm:inline text-sm text-muted-foreground font-normal", children: index + 1 }),
              String(option),
              !answering && index === correctIndex && /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Check, { className: "w-5 h-5 ml-auto" })
            ]
          },
          `${option}-${index}`
        )) }),
        answering && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntime.jsx(
          ui.Button,
          {
            variant: "ghost",
            size: "sm",
...
function LearnSeeCard({ item, onContinue }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Card,
    {
      ...
      className: "border-t-2 border-t-amber-300 shadow-md",
      children: /* @__PURE__ */ jsxRuntime.jsxs(ui.CardContent, { className: "pt-6 pb-8 space-y-6 text-center", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-xs uppercase tracking-wide text-muted-foreground", children: "Take another look" }),
        /* @__PURE__ */ jsxRuntime.jsxs("p", { className: "text-2xl md:text-3xl font-bold", children: [
          item.prompt,
          " = ",
          learnAnswerDisplay(item)
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-muted-foreground", children: "You'll get a chance at this one again in a moment." }),
...
function LearnSessionHost({
  ...
  const ui = useMathmogUI();
  const [session, setSession] = React__namespace.useState(() => {
  ...
  const [step, setStep] = React__namespace.useState(0);
  const apply = (result) => {
  ...
  if (phase === "module-complete") {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { "data-noah": "mathmog-learn-session", className: "space-y-4", children: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  if (item === void 0 || itemState === void 0) {
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Alert, { variant: "destructive", children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.AlertTitle, { children: "Something went wrong" }),
      /* @__PURE__ */ jsxRuntime.jsx(ui.AlertDescription, { children: "This Learn session doesn't match its fact set. Please start the module again." })
    ] });
  }
  const onAnswer = (correct) => apply(applyLearnAnswer(session, config, correct));
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { "data-noah": "mathmog-learn-session", className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-baseline justify-between gap-4 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-medium truncate", title: module.label, children: module.label }),
    ...
    itemState.tier === "see" ? /* @__PURE__ */ jsxRuntime.jsx(
      LearnSeeCard,
      {
        item,
      ...
      step
    ) : itemState.tier === "recognize" ? /* @__PURE__ */ jsxRuntime.jsx(
      LearnRecognizeCard,
      {
        item,
        distractorSet,
...
exports.acceptedLearnAnswers = acceptedLearnAnswers;
exports.gradeLearnRecall = gradeLearnRecall;
exports.learnAnswerDisplay = learnAnswerDisplay;
exports.learnAnswerRevealDisplay = learnAnswerRevealDisplay;
exports.learnModuleTopic = learnModuleTopic;
