        ...
        if (type === 'fraction') {
            ...
            switch (conversionType) {
                ...
                case 'percToFrac': {
                    ...
                    const questionPercent = parseFloat(percentValue.toFixed(places - 1));
                ...
                case 'percToDec': {
                    const pPlaces = Math.max(0, precision-1);
                    const dPlaces = pPlaces + 2;
                    ...
                    const answer = parseFloat(decimalValue.toFixed(dPlaces));
